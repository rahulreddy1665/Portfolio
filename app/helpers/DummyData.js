const projects = [
  {
    ...
    icon: 'book',
    description:
      'Constructed a LMS which allows the users to learn new things with the different module system of the app. Implemented timers in the application for tracking the completion time of each module',
...

  {
    ...
    icon: 'doctor',
    description:
      'Constructed a small animal veterinary calculator app which saves the users time and improves patient outcomes by providing quick & easy to use Veterinary calculators',
    link: 'https://play.google.com/store/apps/details?id=com.readyvetapp',
  },
  {
    name: 'Connect me',
    icon: 'robot',
